...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference("Solution.count") do
      post solutions_url, params: { solution: { category: @solution.category, evidence: @solution.evidence, impact: @solution.impact, published: @solution.published, summary: @solution.summary, title: @solution.title, url: @solution.url } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { category: @solution.category, evidence: @solution.evidence, impact: @solution.impact, published: @solution.published, summary: @solution.summary, title: @solution.title, url: @solution.url } }
